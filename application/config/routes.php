...
$route['admin/handovers/preview-checkout/(:num)'] = 'admin/handover/preview_checkout/$1';
$route['admin/handovers/(:num)/preview-checkout'] = 'admin/handover/preview_checkout/$1';
$route['admin/handovers/checkout/(:num)'] = 'admin/handover/checkout/$1';
$route['admin/handovers/(:num)/checkout'] = 'admin/handover/checkout/$1';
$route['admin/handovers/save-checkout/(:num)'] = 'admin/handover/save_checkout/$1';
$route['admin/handovers/reset-checkout/(:num)'] = 'admin/handover/reset_checkout/$1';
